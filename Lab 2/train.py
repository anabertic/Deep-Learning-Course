...
config['lr_policy'] = {1:{'lr':1e-1}, 3:{'lr':1e-2}, 5:{'lr':1e-3}, 7:{'lr':1e-4}} #param_delta
...
net = []
inputs = np.random.randn(config['batch_size'], 1, 28, 28) #cemu normalna razdioba, neki placeholder za stvarne podatke? samo zbog shapea?
net += [layers.Convolution(inputs, 16, 5, "conv1")] #num filters = 16, kernel size= 5
